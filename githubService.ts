 ...
 * @returns {Promise<Repo[]>} A promise that resolves to an array of the user's repositories.
 * @example
 ...
 * @example
 * const octokit = initializeOctokit(token);
 * await deleteRepo(octokit, 'my-user', 'my-repo-to-delete');
 */
 ...
 * @example
 * const octokit = initializeOctokit(token);
 * const tree = await getRepoTree(octokit, 'my-user', 'my-repo');
 */
 ...
 * @example
 * const octokit = initializeOctokit(token);
 * const content = await getFileContent(octokit, 'my-user', 'my-repo', 'src/index.js');
 */
 ...
 * @param {string} owner The repository owner.
 * @param {string} repo The repository name.
 * @param {object[]} files An array of file objects with path and content.
 * @param {string} files[].path The path of the file to commit.
